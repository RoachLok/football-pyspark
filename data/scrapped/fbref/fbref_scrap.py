...
# Needed for Python versions where relative import paths are not supported.
#import os, sys
...
if __name__ == "__main__":
    ...
    with Pool() as p:
        json_urls = p.map(get_json_url, get_municipalities_pop_json_urls()) # Came here to check on 22/01/22. Regex wasnt working.
